...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Add recurring events to your Rails app}
  spec.description   = %q{A Rail engine for adding recurring events to Rail with helpers for models and views.}
